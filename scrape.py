...
def grab_job_links(soup):
    ...
    Parameters:
        soup: the soup object corresponding to a search result page
                e.g. https://ca.indeed.com/jobs?q=data+scientist&l=ohio&start=20
...
if __name__ == "__main__":
    queries = ["data scientist", "mobile application developer", "data analyst"]
    ...
    get_data(query, num_pages, location='Ohio')